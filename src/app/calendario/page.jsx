...
<div  >
     ...
     <div className=" grid lg:grid-cols-1 sm:grid-cols-1 md:grid-cols-1  gap-3 mt-2 lg:h-auto sm:h-auto">
        ...
        <div key={index} >
          ...
          <div  className=" grid lg:grid-cols-2 sm:grid-cols-1 md:grid-cols-1 gap-5 ">
                ...
                <Image
                        ...
                        height={0}
                        sizes="100vw"
                        className="lg:w-[calc(50vh-2rem)] sm:w-full sm:h-[calc(40vh-1rem)]  mx-auto my-auto lg:h-[calc(40vh-4rem)] rounded-lg mb-2 mt-4 "
                      />
                <div>
...
<div className="grid grid-cols-1 lg:grid-cols-2 my-2 p-1">
  ...
  <img   src={caballo.src} alt="boyero" className="lg:w-[calc(50vh-2rem)] sm:w-full sm:h-[calc(30vh-1rem)]  mx-auto my-auto lg:h-[calc(40vh-4rem)] rounded-lg mb-2 mt-4 "/>
...
<div className="grid grid-cols-1 lg:grid-cols-2 my-10  p-4 ">
  ...
  <img   src={san.src} alt="boyero" className="lg:w-[calc(50vh-2rem)] sm:w-full sm:h-[calc(30vh-1rem)]  mx-auto my-auto lg:h-[calc(40vh-4rem)] rounded-lg mb-2 mt-4 "/>
  </div>
  <div className="my-auto">
