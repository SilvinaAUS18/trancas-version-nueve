...
<div className='container mx-auto'>
    <Carousel/>
     ...
     <div className=" grid lg:grid-cols-1 sm:grid-cols-1 md:grid-cols-1  gap-3 mt-10 lg:h-auto ">
        ...
        <div key={index} >
          ...
          <div  className=" grid lg:grid-cols-2 sm:grid-cols-1 md:grid-cols-1 gap-5 ">
                ...
                <Image
                        ...
                        height={0}
                        sizes="100vw"
                        className="lg:w-[calc(50vh-1rem)] sm:w-full sm:h-[calc(30vh-1rem)] mx-auto lg:h-[calc(40vh-2rem)] rounded-lg mb-2 mt-2"
                        />
                <div>
    ...
    <div className=' w-full bg-slate-300 items-center'>
       <Link href="/noticias-home" className="text-xl  font-bold bg-blue-700 text-white px-10 rounded-2xl  "  > Todas las  Noticias</Link> 
    </div>
